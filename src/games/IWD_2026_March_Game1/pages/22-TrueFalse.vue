...
import header from '../assets/IWD_Game_March_Game1_2_GamePlay_Header1.webp'
import item from '../assets/IWD_Game_March_Game1_2_GamePlay_Option1.webp'
import result from '../assets/IWD_Game_March_Game1_2_GamePlay_Result1.webp'
